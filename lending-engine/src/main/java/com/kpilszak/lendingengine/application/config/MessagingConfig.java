package com.kpilszak.lendingengine.application.config;

import com.kpilszak.lendingengine.domain.event.UserRegisteredEventHandler;
...
public class MessagingConfig {
	...
	private static final String TOPIC = "userRegisteresTopic";
